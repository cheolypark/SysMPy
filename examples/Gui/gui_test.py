...
i_init_roll.Property('Thickness', range=[10, 20])
i_init_roll.Property('Width', range=[10, 11, 12])
i_init_roll.Property('Length', range=[10, 20])
i_init_roll.Property('Temperature', range=[10, 11, 12])
