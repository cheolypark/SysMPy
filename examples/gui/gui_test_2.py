...
p = Process('Process')
PS, IF, HT, HR, SP, CR, AL, PL, FR, SL, IL = p.And('Production Start', 'Induction Furnace', 'Heater',
                                                   'Hot Rolling Mill', 'Scalper',
                                                   'Cold Rolling Mill', 'Annealing Line', 'Pickling Line',
                                                   'Finish Rolling Mill', 'Slitting Line', 'Inspection Line')
